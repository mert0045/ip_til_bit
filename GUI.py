...
def ip_til_binær(ip):
    """Konverterer en IP-adresse til en 32-bit binær streng uden punktnotation."""
...
def anvend_subnetmaske(ip, subnetmaske):
    """Finder netværksadressen ved at udføre en bitwise AND mellem IP og subnetmaske."""
...
# Subnetmaske
tk.Label(root, text="Subnetmaske:", font=("Arial", 12), bg="#2E2E2E", fg=label_fg).grid(row=0, column=0, padx=10, pady=5, sticky="e")
entry_subnet = tk.Entry(root, font=("Arial", 12), bg=entry_bg, fg=entry_fg)
entry_subnet.grid(row=0, column=1, padx=10, pady=5)
label_subnet_bin = tk.Label(root, text="00000000.00000000.00000000.00000000", font=("Arial", 10), bg="#2E2E2E", fg=label_fg)
label_subnet_bin.grid(row=1, column=1)

# IP 1
tk.Label(root, text="IP-adresse 1:", font=("Arial", 12), bg="#2E2E2E", fg=label_fg).grid(row=2, column=0, padx=10, pady=5, sticky="e")
...
# IP 2
tk.Label(root, text="IP-adresse 2:", font=("Arial", 12), bg="#2E2E2E", fg=label_fg).grid(row=4, column=0, padx=10, pady=5, sticky="e")
